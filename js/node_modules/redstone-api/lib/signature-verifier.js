...
var SignatureVerifier = /** @class */ (function () {
    function SignatureVerifier(arweaveProxy) {
        this.arweaveProxy = arweaveProxy;
    }
    SignatureVerifier.prototype.assertValidSignature = function (_price) {
    ...
    SignatureVerifier.prototype.getPriceSignedData = function (price) {
        var _a;
        ...
        if (price.version === "3" || ((_a = price.version) === null || _a === void 0 ? void 0 : _a.includes("."))) {
